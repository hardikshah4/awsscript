...
variable "b-firewallname" {
  description = "Enter the name of the AWS VM-firewall - Example: hshah-fw"
}
...
variable "g-panoramaname" {
  description = "Enter the name of the AWS VM-panorama - Example: hshah-panorama"
}

variable "h-securitygroup" {
